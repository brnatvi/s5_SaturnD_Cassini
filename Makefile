...
saturnd: src/saturnd.c src/listd.c
	gcc -I include -o saturnd src/saturnd.c src/client-request.c src/listd.c src/run-daemon.c src/timing-text-io.c src/daemon-aux-functions.c src/daemon-proc-tasks.c
